...
let newVal = fruits.concat(moreFruits);

// Log the name of all fruit in console

newVal.forEach((val) => console.log(val));

// Convert each fruit name to lowercase and log it

newVal.forEach((val) => val.toLowerCase());

// Convert all fruits name into lowercase and store in new array named lowercaseFruits

let lowercaseFruits = newVal.map((val) => val.toLowerCase());
...
let oddNumbers = numbersThree.filter((number) => numbers % 2 !== 0);

// Create a new variable named evenNumbers that store all the even numbers in numbersThree array

let evenNumbers = numbersThree.filter((number) => numbers % 2 === 0);
