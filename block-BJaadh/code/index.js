...
strings.filter((v) => v.includes("is"));

// - Find all the words that contain 'is' use string method 'indexOf'

strings.filter((v) => v.indexOf("is") !== -1);
...
let stringLength = strings.map((v) => v.length);

// - Find the sum of the length of words using above question

let reduced = stringLength.reduce((acc, current) => acc + current);
